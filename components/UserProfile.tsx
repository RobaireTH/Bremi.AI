      ...
      <div className="flex-1 overflow-y-auto p-6 pb-32">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {SUPPORTED_LANGUAGES.map((lang) => (
                <button
                  ...
                  className={`p-3 rounded-xl text-sm font-medium border transition-all ${language === lang.code
          ...
          <button
            ...
            className={`w-full py-3.5 rounded-xl font-medium flex items-center justify-center transition-all shadow-md ${isSaved
