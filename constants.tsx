...
export const TRANSLATIONS = {
  en: {
    ...
    instructions: "Pick a calm tool. You can breathe with me, ground your senses, or do a gentle body scan.",
    your_profile: "",
  ...
  yo: {
    ...
    instructions: "Yan irinṣẹ fun idakẹjẹ. O le simi jinlẹ, lo imọlara ara rẹ, tabi ṣe ayẹwo ara didùn.",
    your_profile: "",
    name_label: "Oruko",
  ...
  ha: {
    ...
    instructions: "Zaɓi hanyar hutawa. Za mu iya numfashi tare, mu maida hankali ga hankalinka, ko mu binciki jikinka a hankali.",
    your_profile: "",
    name_label: "Suna",
  ...
  ig: {
    ...
    instructions: "Họrọ ụzọ izu ike. Ị nwere ike kesaa ume, jiri mmetụta gị mee atụmatụ, ma ọ bụ nyochaa ahụ nwayọ nwayọ.",
    your_profile: "",
    name_label: "Aha Gị",
